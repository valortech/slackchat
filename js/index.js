(function() {
	...
	angular.module('valortech.slackChat', []);
	angular.module('valortech.slackChat').directive('valortechSlackChat', ['$timeout', SlackChat]);

	function SlackChat($timeout) {
		var directive = {
			restrict: 'EA',
			templateUrl: '/plugins/slackchat/html/chatTemplate.html',
			replace: true,
			scope: {
				messages: '=',
				username: '=',
